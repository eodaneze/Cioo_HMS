<?php
 ...
 if(isset($_POST['submit'])){
    ...
    $title = isset($_POST['address2']) ? trim($_POST['title']) : "";
    ...
    if($name == "" || $email == "" || $password == ""|| $cpassword == "" || $address2 == "" || $title == "" || $phone == ""|| $gender == "" || $mstatus == "" || $dob == "" || $bgroup == "" || $geno == "" || $mchal == "" ){
            ...
            if(in_array($fileactualext, $allow)){
                if($filesize < 8000000){
                    ...
                    if(move_uploaded_file($filetmp, $filedestination)){
                        $sql = "INSERT INTO patient(name, email,password, address2, title, phone, gender, mstatus, dob, bgroup, genotype, mchallenge, pic, createddate)VALUES('$name', '$email','$password','$address2', '$title', '$phone', '$gender', '$mstatus', '$dob', '$bgroup', '$geno', '$mchal', '$pic', '$md')";
